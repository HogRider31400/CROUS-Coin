...
class testCorpsFini(unittest.TestCase):
    ...
    def testRepr(self):
        self.assertEqual(repr(self.CF1),"(3, 7)")

    def testEqual(self):
        self.assertFalse(self.CF1==self.CF2)
        self.assertTrue(self.CF1==self.CF1)
    ...
    def testTrueDiv(self):
        self.assertEqual(self.CF1/self.CF2, CorpsFini(((3*5**(5))%7),7))
